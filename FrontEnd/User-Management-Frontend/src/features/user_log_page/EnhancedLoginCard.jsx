...
function EnhancedLoginCard() {
  ...
  const[createUser,{isSignUpLoading,isSuccess,error}]=useCreateUserMutation()
  ...
  return (
    <div className="min-h-screen flex items-start  justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-4 relative overflow-hidden">
      ...
      {/* Login Card */}
    <Card className={`w-full ${signState==='Sign In' ? 'mt-28' :'mt-14' }  max-w-md relative z-10 bg-white/10 backdrop-blur-xl border-white/20 shadow-2xl`}>
